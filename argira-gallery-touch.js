...
(function () {
  ...
  function attachTouchToCard(cardImg, objectMap) {
    ...
    // Dibujar imagen en canvas cuadrado 512×512 (zonas 3×3 siempre coherentes)
    ...
    function handleTouch(e) {
      ...
      // Zona 3×3 — usar posición relativa en la imagen VISIBLE (rect), no en el canvas interno.
      // px/SIZE y py/canvas.height fallan cuando el canvas no es cuadrado (aspect ratio real de la imagen),
      // porque scaleX y scaleY son distintos, desplazando las zonas. clientX/Y sobre rect siempre es correcto.
