...
// ========== 0. i18n UI — strings inyectados por JS ==========
// El proyecto nació en castellano; estos son los textos de interfaz que el
// propio script escribe en el DOM (botones dinámicos, estados, mensajes).
// t('clave') devuelve el string en el idioma de <html lang="...">.
// No cambia ninguna lógica: solo sustituye el texto que se muestra.
window.ArgiraStrings = {
  es: {
    detener:            'Detener',
    detenerTodo:        'Detener todo',
    oirLaObra:          'Oír la obra',
    calculando:         'Calculando…',
    tourSonoro:         'Tour sonoro',
    tourEspacial:       'Tour espacial',
    estructuraEspacial: 'Estructura espacial',
    leerDescripcion:    '🔊 Leer descripción',
    lector:             '♿ Lector',
    analizando:         'Analizando v3.5…',
    audioListo:         'Audio listo · Pulsa Escuchar',
    cargandoAudio:      'Cargando audio…',
    cargandoImagen:     'Cargando imagen…',
    errorNoEncontrado:  'no encontrado',
    errorProcesarImg:   'Error al procesar la imagen.',
    errorLectura:       'Error de lectura.',
    errorPrefijo:       'Error: ',
    escuchaYElige:      'Escucha y elige',
    irEncuesta:         'Ir a la encuesta →',
    reproduciendoA:     'Reproduciendo a ',
    sintetizando:       'Sintetizando audio…',
    wavDescargado:      'WAV descargado a ',
    sinRespuesta:       '— Sin respuesta',
    correcto:           '✓ Correcto',
    incorrecto:         '✗ Incorrecto',
    detenido:           '✓ Detenido',
    scrollLibre:        '✓ Scroll libre',
    rugosidad:          'rugosidad',
    hintAuriculares:    '🎧 Usa auriculares para oír la posición espacial del color',
    hintTocaColorPunto: '👆 Toca la imagen para oír el color de ese punto',
    hintTocaPosicion:   '👆 Toca la imagen para oír posición y color',
    parDe:              'Par {n} de 5',
    sonidoA:            'Sonido A',
    sonidoB:            'Sonido B',
    preguntaVariabilidad: '¿Cuál tiene mayor variabilidad cromática (más color, más caos)?',
    elSonidoA:          'El Sonido A',
    elSonidoB:          'El Sonido B',
    noSe:               'No sé',
    correctoMinuscula:  'correcto',
    modoTocar:          'Tocar',
    modoBarrido:        'Barrido',
    modoBraille:        'Braille',
    alertErrorSintesis: '❌ Error en síntesis: ',
    alertErrorImagen:   '❌ No se pudo procesar la imagen.',
    alertErrorLectura:  '❌ Error al leer el archivo.',
    ariaModoTocar:      'Modo tocar: toca la imagen para oír posición y color',
    ariaModoBarrido:    'Modo barrido: desliza para explorar tonos en tiempo real',
    ariaModoBraille:    'Modo braille: desliza despacio, oirás cada zona antes de avanzar',
    scrollBloqueado:    '🔒 Scroll bloqueado',
    announceTocar:      'Modo tocar. Scroll libre. Toca la imagen para oír posición y color.',
    announceBarrido:    'Modo barrido activado. Scroll bloqueado. Desliza para explorar tonos.',
    announceBraille:    'Modo braille activado. Scroll bloqueado. Desliza despacio, oirás posición y descripción de cada zona.',
    masFormasExplorar:  'Más formas de explorar esta obra'
  },
  en: {
    detener:            'Stop',
    detenerTodo:        'Stop all',
    oirLaObra:          'Hear the artwork',
    calculando:         'Calculating…',
    tourSonoro:         'Sound tour',
    tourEspacial:       'Spatial tour',
    estructuraEspacial: 'Spatial structure',
    leerDescripcion:    '🔊 Read description',
    lector:             '♿ Reader',
    analizando:         'Analyzing v3.5…',
    audioListo:         'Audio ready · Press Play',
    cargandoAudio:      'Loading audio…',
    cargandoImagen:     'Loading image…',
    errorNoEncontrado:  'not found',
    errorProcesarImg:   'Error processing the image.',
    errorLectura:       'Read error.',
    errorPrefijo:       'Error: ',
    escuchaYElige:      'Listen and choose',
    irEncuesta:         'Go to survey →',
    reproduciendoA:     'Playing at ',
    sintetizando:       'Synthesizing audio…',
    wavDescargado:      'WAV downloaded at ',
    sinRespuesta:       '— No answer',
    correcto:           '✓ Correct',
    incorrecto:         '✗ Incorrect',
    detenido:           '✓ Stopped',
    scrollLibre:        '✓ Free scroll',
    rugosidad:          'roughness',
    hintAuriculares:    '🎧 Use headphones to hear the spatial position of the color',
    hintTocaColorPunto: '👆 Touch the image to hear the color at that point',
    hintTocaPosicion:   '👆 Touch the image to hear position and color',
    parDe:              'Pair {n} of 5',
    sonidoA:            'Sound A',
    sonidoB:            'Sound B',
    preguntaVariabilidad: 'Which one has greater chromatic variability (more color, more chaos)?',
    elSonidoA:          'Sound A',
    elSonidoB:          'Sound B',
    noSe:               "I don't know",
    correctoMinuscula:  'correct',
    modoTocar:          'Tap',
    modoBarrido:        'Sweep',
    modoBraille:        'Braille',
    alertErrorSintesis: '❌ Synthesis error: ',
    alertErrorImagen:   '❌ Could not process the image.',
    alertErrorLectura:  '❌ Error reading the file.',
    ariaModoTocar:      'Tap mode: touch the image to hear position and color',
    ariaModoBarrido:    'Sweep mode: drag to explore tones in real time',
    ariaModoBraille:    'Braille mode: drag slowly, you will hear each zone before advancing',
    scrollBloqueado:    '🔒 Scroll locked',
    announceTocar:      'Tap mode. Free scroll. Touch the image to hear position and color.',
    announceBarrido:    'Sweep mode activated. Scroll locked. Drag to explore tones.',
    announceBraille:    'Braille mode activated. Scroll locked. Drag slowly, you will hear the position and description of each zone.',
    masFormasExplorar:  'More ways to explore this artwork'
  }
};
window.t = function (key) {
  const pageLang = (document.documentElement.lang || 'es').toLowerCase();
  const dict = pageLang.startsWith('en') ? window.ArgiraStrings.en : window.ArgiraStrings.es;
  return (key in dict) ? dict[key] : (window.ArgiraStrings.es[key] || key);
};
  ...
  testPairs.forEach(p => {
    ...
    pairDiv.innerHTML = `
      <div class="test-pair-header">
        <span class="test-pair-num">${t('parDe').replace('{n}', p.pair)}</span>
        <span class="test-pair-status" id="status-${p.pair}">${t('escuchaYElige')}</span>
      </div>
      <div class="test-players">
        <div class="test-player">
          <span class="test-player-label">${t('sonidoA')}</span>
          <audio controls aria-label="${t('sonidoA')} del par ${p.pair}">
            <source src="${p.audioA}" type="audio/wav">
          </audio>
        </div>
        <div class="test-player">
          <span class="test-player-label">${t('sonidoB')}</span>
          <audio controls aria-label="${t('sonidoB')} del par ${p.pair}">
            <source src="${p.audioB}" type="audio/wav">
          </audio>
        </div>
      </div>
      <div class="test-question">
        <p>${t('preguntaVariabilidad')}</p>
        <div class="test-buttons">
          <button class="test-btn" data-pair="${p.pair}" data-choice="A" data-correct="${p.correct === 'A'}">${t('elSonidoA')}</button>
          <button class="test-btn" data-pair="${p.pair}" data-choice="B" data-correct="${p.correct === 'B'}">${t('elSonidoB')}</button>
          <button class="test-btn" data-pair="${p.pair}" data-choice="?" data-correct="false">${t('noSe')}</button>
        </div>
      </div>
      <div class="test-reveal" id="reveal-${p.pair}">
        <div class="reveal-item" id="reveal-item-${p.pair}-A">
          ...
          <div class="reveal-item-label"><strong>${t('sonidoA')} ${p.correct === 'A' ? '✓ ' + t('correctoMinuscula') : ''}</strong><span>${p.labelA}</span></div>
        </div>
        <div class="reveal-item" id="reveal-item-${p.pair}-B">
          <img src="${p.imgB}" alt="${p.labelB}" loading="lazy" crossorigin="anonymous">
          <div class="reveal-item-label"><strong>${t('sonidoB')} ${p.correct === 'B' ? '✓ ' + t('correctoMinuscula') : ''}</strong><span>${p.labelB}</span></div>
        </div>
      </div>
    `;
...
function answerHandler(e) {
  ...
  let announcement = '';
  if (choice === '?') {
    status.textContent = t('sinRespuesta');
    ...
    status.textContent = t('incorrecto');
...
function resetTest() {
  ...
  for (let i = 1; i <= totalPairs; i++) {
    ...
    if (status) { status.textContent = t('escuchaYElige'); status.removeAttribute('data-state'); }
    if (pairDiv) {
...
document.querySelectorAll('.speak-btn').forEach(btn => {
  btn.addEventListener('click', function () {
    ...
    if (window.ArgiraSpeech.speaking && (currentOriginal === text || (window.ArgiraSpeech.current && window.ArgiraSpeech.current.text === text))) {
      ...
      this.innerHTML = t('leerDescripcion');
    } else {
      window.ArgiraSpeech.stop();
      window.ArgiraSpeech.speak(text, { rate: 0.95 });
      this.classList.add('speaking');
      this.innerHTML = t('detener');
      const self = this;
      const checkEnd = setInterval(() => {
        if (!window.ArgiraSpeech.current) {
          ...
          self.innerHTML = t('leerDescripcion');
        }
      }, 100);
...
function argiraTestScan(btn) {
  ...
  function runScan() {
    ...
    btn.innerHTML = '<span aria-hidden="true">⏹</span> ' + t('detener');
    ...
    function stop() {
      ...
      btn.innerHTML = '<span aria-hidden="true">🕐</span> ' + t('tourSonoro');
...
async function loadBuffer() {
  ...
  if (statusDiv) statusDiv.textContent = t('cargandoAudio');
  try {
    ...
    if (statusDiv) statusDiv.textContent = t('errorPrefijo') + wavUrl + ' ' + t('errorNoEncontrado');
    return null;
  }
}
...
async function playLupa() {
  ...
  if (statusDiv) statusDiv.textContent = t('reproduciendoA') + speed.toFixed(2) + '× · Matisse';
...
function processFile(file) {
  ...
  if (statusEl)   statusEl.textContent   = t('cargandoImagen');

  const reader = new FileReader();
  reader.onload = (e) => {
    const dataUrl = e.target.result;
    if (preview) preview.src = dataUrl;
    if (statusEl) statusEl.textContent = t('analizando');
    ...
    img.onload = () => {
      ...
      if (statusEl) statusEl.textContent = t('sintetizando');
      ...
      setTimeout(() => {
        try {
          ...
          if (statusEl) statusEl.textContent = t('audioListo');
          ...
          alert(t('alertErrorSintesis') + err.message);
          if (statusEl) statusEl.textContent = t('errorPrefijo') + err.message;
        }
      }, 50);
    };

    img.onerror = () => {
      alert(t('alertErrorImagen'));
      if (statusEl) statusEl.textContent = t('errorProcesarImg');
    };
    img.src = dataUrl;
  };
  reader.onerror = () => {
    alert(t('alertErrorLectura'));
    if (statusEl) statusEl.textContent = t('errorLectura');
  };
...
if (btnPlayTu) {
  btnPlayTu.addEventListener('click', async function() {
    ...
    if (statusEl) statusEl.textContent = t('reproduciendoA') + speed.toFixed(2) + '× · ' + currentFileName;
  });
}
...
if (btnDL) {
  btnDL.addEventListener('click', function() {
    ...
    if (statusEl) statusEl.textContent = t('wavDescargado') + speed.toFixed(2) + '× · ' + a.download;
  });
}
...
function initGallerySonify() {
  ...
  cards.forEach(card => {
    ...
    btn.setAttribute('aria-pressed', 'false');
    btn.innerHTML = '<span aria-hidden="true">🎵</span> ' + t('oirLaObra');
    ...
    function synthesizeAndPlay() {
      ...
      btn.innerHTML = '<span aria-hidden="true">⏳</span> ' + t('calculando');
      btn.disabled = true;
      setTimeout(() => {
        try {
          const SIZE = 128;
...
(function initAccessibilityToggle() {
  ...
  // Crear botón de toggle e insertarlo en el nav
  const btn = document.createElement('button');
  btn.id = 'btn-reader-mode';
  btn.className = 'nav-link';
  btn.setAttribute('aria-pressed', localStorage.getItem(KEY) === '1' ? 'true' : 'false');
  btn.setAttribute('aria-label', 'Activar modo lector de pantalla');
  btn.type = 'button';
  btn.textContent = t('lector');

  function applyMode(active) {
    document.body.classList.toggle('argira-accessibility-mode', active);
    btn.setAttribute('aria-pressed', active ? 'true' : 'false');
    btn.setAttribute('aria-label', active ? 'Desactivar modo lector de pantalla' : 'Activar modo lector de pantalla');
    ...
    if (liveRegion) {
      ...
      setTimeout(() => {
        liveRegion.textContent = active
          ? 'Modo lector de pantalla activado. El canvas táctil está desactivado.'
          : 'Modo lector de pantalla desactivado. Canvas táctil disponible.';
      }, 50);
    }
  }

  btn.addEventListener('click', () => {
    applyMode(!document.body.classList.contains('argira-accessibility-mode'));
  });
...
function initGalleryTouch() {
  ...
  cards.forEach(card => {
    ...
    hint.textContent = t('hintTocaPosicion');
    ...
    hintHeadphones.textContent = t('hintAuriculares');
    ...
    modeBar.innerHTML = `
      <button class="argira-mode-btn argira-mode-active" data-mode="tap" aria-pressed="true" aria-label="${t('ariaModoTocar')}"><span aria-hidden="true">👆</span> ${t('modoTocar')}</button>
      <button class="argira-mode-btn" data-mode="sweep" aria-pressed="false" aria-label="${t('ariaModoBarrido')}"><span aria-hidden="true">🖐</span> ${t('modoBarrido')}</button>
      <button class="argira-mode-btn" data-mode="braille" aria-pressed="false" aria-label="${t('ariaModoBraille')}"><span aria-hidden="true">🦯</span> ${t('modoBraille')}</button>`;
    ...
    modeStatus.textContent = t('scrollLibre');

    const MODE_INFO = {
      tap:    { status: t('scrollLibre'),     announce: t('announceTocar') },
      sweep:  { status: t('scrollBloqueado'), announce: t('announceBarrido') },
      braille:{ status: t('scrollBloqueado'), announce: t('announceBraille') }
    };
    ...
    exploreSummary.innerHTML =
      '<span><span aria-hidden="true">🔍</span> ' + t('masFormasExplorar') + '</span>' +
      '<span class="argira-details-arrow" aria-hidden="true">▼</span>';
...
function initRoughnessWidgets() {
  ...
  cards.forEach(card => {
    ...
    if(pct !== null) {
      ...
      rBar.textContent = `${t('rugosidad')} ${roughnessBar(pct)} ${pct}%`;
    ...
    narrBtn.innerHTML = '<span aria-hidden="true">🦯</span> ' + t('estructuraEspacial');
...
function initClockScan() {
  ...
  cards.forEach(card => {
    ...
    scanBtn.innerHTML = '<span aria-hidden="true">🖼️</span> ' + t('tourEspacial');
    ...
    scanBtn.addEventListener('click', function() {
      ...
      scanBtn.innerHTML = '<span aria-hidden="true">⏹</span> ' + t('detener');
...
function initCanvasTouch() {
  ...
  const hint = document.createElement('p');
  hint.textContent = t('hintTocaColorPunto');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (stopAllBtn) {
    stopAllBtn.addEventListener('click', () => {
      ...
      setTimeout(() => {
        stopAllBtn.innerHTML = '<span aria-hidden="true">⏹</span> ' + t('detenerTodo');
