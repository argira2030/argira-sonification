...
function initGalleryTouch() {
  ...
  cards.forEach(card => {
    ...
    modeBar.innerHTML = `
      <button class="argira-mode-btn argira-mode-active" data-mode="tap" aria-pressed="true">👆 Tocar</button>
      <button class="argira-mode-btn" data-mode="sweep" aria-pressed="false">🖐 Barrido</button>
      <button class="argira-mode-btn" data-mode="braille" aria-pressed="false">🦯 Braille</button>`;
