...
function initGalleryTouch() {
  ...
  cards.forEach(card => {
    ...
    function handleGalleryTouch(e) {
      ...
      // Compensar aspect ratio: el canvas puede no llenar todo el rect CSS
      const imgAspect = tc.width / tc.height;
      ...
      const px = Math.round(x / drawWidth  * tc.width);
      const py = Math.round(y / drawHeight * tc.height);
