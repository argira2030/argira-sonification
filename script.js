    ...
    const completion = new Promise(resolve => {
      ...
      const doSpeak = () => {
        ...
        function speakNext(chunkRetries) {
          ...
          // El idioma por defecto se detecta desde <html lang="..."> (fijado en cada
          // versión del HTML: 'en' en index.html, 'es' en index-es.html), en vez de
          // depender de que cada llamada a speak() pase un lang explícito.
          const pageLang = (document.documentElement.lang || 'es').toLowerCase();
          const defaultLang = pageLang.startsWith('en') ? 'en-US' : 'es-ES';
          Object.assign(u, { lang: defaultLang, rate: 0.95, volume: 0.9, ...opts });
          self.current = u;
          u.onend = () => {
